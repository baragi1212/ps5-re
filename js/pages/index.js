...
const $consoleTitle = document.querySelector(".console__content__title");
const $consoleVisual = document.querySelector(".console__content__visual");
...
function initAll() {
  ...
  gsap.set([
    $consoleTitle, $consoleVisual, $consoleContent,
...
function initConsoleAnimation() {
  ...
  tl.from($consoleTitle, { y: -100, opacity: 0, duration: 1, ease: "power2.out" }, 0)
    .from($consoleVisual, { y: 100, opacity: 0, duration: 1, ease: "power2.out" }, 0);
